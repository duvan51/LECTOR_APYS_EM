  ...
  <div className="App">
    ...
    <table>
      ...
      <tr key={item.id}>
        ...
        <td>
          {editingProductId === item.id ? (
            ...
            <form>
              ...
              <button type="button" onClick={() => handleSaveClick(item.id)}>
                Guardar
              </button>
        ...
        <td>{item.categories.length > 0 ? item.categories[0].name : ''}</td>
        <td>
            <a
            href={item.permalink}
            target="_blank"
            ...
            onClick={(e) => {
              ...
              handleDeleteClick(item.id); // Llama a la función de eliminación
            }}
            >
          ...
          {editingProductId !== item.id && (
            ...
            onClick={(e) => {
              e.preventDefault(); // Evita que el enlace se abra inmediatamente
              handleUpdateClick(item.id); // Llama a la función de eliminación
            }}
            >
